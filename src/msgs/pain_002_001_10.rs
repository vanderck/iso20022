...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:pain.002.001.10".to_string()
}
::lazy_static::lazy_static! { static ref ACTIVE_CURRENCY_CODE_REGEX: Lazy<Regex> = Lazy::new(|| {Regex::new(r"^[A-Z]{3,3}$").unwrap()});}
#[derive(Debug, Default, Clone, PartialEq, ::serde::Serialize, ::serde::Deserialize, ::derive_builder::Builder, ::validator::Validate)]
...
pub struct CurrencyExchange13 {
        #[validate]
        #[serde(rename = "SrcCcy")]
        pub srcccy: ActiveCurrencyCode,
        #[validate]
        #[serde(rename = "TrgtCcy")]
        pub trgtccy: ActiveCurrencyCode,
        #[validate]
        #[serde(rename = "XchgRate")]
        pub xchgrate: BaseOneRate,
        #[validate]
        #[serde(rename = "UnitCcy", skip_serializing_if = "Option::is_none")]
        pub unitccy: Option<ActiveCurrencyCode>,
}
#[derive(Debug, Default, Clone, PartialEq, ::serde::Serialize, ::serde::Deserialize, ::derive_builder::Builder, ::validator::Validate)]
pub struct CustomerPaymentStatusReportV10 {
        #[validate]
        #[serde(rename = "GrpHdr")]
        pub grphdr: GroupHeader86,
        #[validate]
        #[serde(rename = "OrgnlGrpInfAndSts")]
        pub orgnlgrpinfandsts: OriginalGroupHeader17,
        #[validate]
        #[serde(rename = "OrgnlPmtInfAndSts", default)]
        pub orgnlpmtinfandsts: Vec<OriginalPaymentInstruction32>,
        #[validate]
...
pub struct Document {
        ...
        pub cstmrpmtstsrpt: CustomerPaymentStatusReportV10,
}
#[derive(Debug, Default, Clone, PartialEq, ::serde::Serialize, ::serde::Deserialize, ::derive_builder::Builder, ::validator::Validate)]
...
pub struct NumberOfTransactionsPerStatus5 {
        ...
        pub dtldsts: ExternalPaymentTransactionStatus1Code,
        #[validate]
...
pub struct OriginalGroupHeader17 {
        ...
        pub grpsts: Option<ExternalPaymentGroupStatus1Code>,
        #[validate]
        #[serde(rename = "StsRsnInf", default)]
        pub stsrsninf: Vec<StatusReasonInformation12>,
        #[validate]
        #[serde(rename = "NbOfTxsPerSts", default)]
        pub nboftxspersts: Vec<NumberOfTransactionsPerStatus5>,
}
#[derive(Debug, Default, Clone, PartialEq, ::serde::Serialize, ::serde::Deserialize, ::derive_builder::Builder, ::validator::Validate)]
pub struct OriginalPaymentInstruction32 {
        ...
        pub pmtinfsts: Option<ExternalPaymentGroupStatus1Code>,
        #[validate]
        #[serde(rename = "StsRsnInf", default)]
        pub stsrsninf: Vec<StatusReasonInformation12>,
        #[validate]
        ...
        pub txinfandsts: Vec<PaymentTransaction105>,
}
#[derive(Debug, Default, Clone, PartialEq, ::serde::Serialize, ::serde::Deserialize, ::derive_builder::Builder, ::validator::Validate)]
...
pub struct PaymentTransaction105 {
        ...
        pub txsts: Option<ExternalPaymentTransactionStatus1Code>,
        #[validate]
        #[serde(rename = "StsRsnInf", default)]
        pub stsrsninf: Vec<StatusReasonInformation12>,
        #[validate]
        ...
        pub trckrdata: Option<TrackerData1>,
        #[validate]
...
pub struct TrackerData1 {
        ...
        pub confddt: DateAndDateTime2Choice,
        #[validate]
        #[serde(rename = "ConfdAmt")]
        pub confdamt: ActiveCurrencyAndAmount,
        #[validate]
        #[validate(length(min = 1))]
        #[serde(rename = "TrckrRcrd", default)]
        pub trckrrcrd: Vec<TrackerRecord1>,
}
#[derive(Debug, Default, Clone, PartialEq, ::serde::Serialize, ::serde::Deserialize, ::derive_builder::Builder, ::validator::Validate)]
pub struct TrackerRecord1 {
        ...
        pub chrgsamt: Option<ActiveCurrencyAndAmount>,
        #[validate]
        #[serde(rename = "XchgRateData", skip_serializing_if = "Option::is_none")]
        pub xchgratedata: Option<CurrencyExchange13>,
}
