...
pub fn namespace() -> String {
    "urn:iso:std:iso:20022:tech:xsd:pain.008.001.08".to_string()
}
...
pub struct CustomerDirectDebitInitiationV08 {
        #[validate]
        #[serde(rename = "GrpHdr")]
        pub grphdr: GroupHeader83,
        #[validate]
        #[validate(length(min = 1))]
        #[serde(rename = "PmtInf", default)]
        pub pmtinf: Vec<PaymentInstruction29>,
        #[validate]
...
pub struct DirectDebitTransaction10 {
        ...
        pub prentfctnid: Option<Max35Text>,
        #[validate]
        #[serde(rename = "PreNtfctnDt", skip_serializing_if = "Option::is_none")]
        pub prentfctndt: Option<ISODate>,
}
#[derive(Debug, Default, Clone, PartialEq, ::serde::Serialize, ::serde::Deserialize, ::derive_builder::Builder, ::validator::Validate)]
pub struct DirectDebitTransactionInformation23 {
        ...
        pub pmttpinf: Option<PaymentTypeInformation29>,
        #[validate]
        ...
        pub drctdbttx: Option<DirectDebitTransaction10>,
        #[validate]
        ...
        pub instrforcdtragt: Option<Max140Text>,
        #[validate]
...
pub struct Document {
        ...
        pub cstmrdrctdbtinitn: CustomerDirectDebitInitiationV08,
}
#[derive(Debug, Default, Clone, PartialEq, ::serde::Serialize, ::serde::Deserialize, ::derive_builder::Builder, ::validator::Validate)]
...
#[derive(Debug, Default, Clone, PartialEq, ::serde::Serialize, ::serde::Deserialize, ::derive_builder::Builder, ::validator::Validate)]
pub struct PaymentInstruction29 {
        #[validate]
        #[serde(rename = "PmtInfId")]
        pub pmtinfid: Max35Text,
        #[serde(rename = "PmtMtd")]
        pub pmtmtd: PaymentMethod2Code,
        #[validate]
        ...
        pub reqdcolltndt: ISODate,
        #[validate]
        #[serde(rename = "Cdtr")]
        pub cdtr: PartyIdentification135,
        #[validate]
        #[serde(rename = "CdtrAcct")]
        pub cdtracct: CashAccount38,
        #[validate]
        ...
        pub drctdbttxinf: Vec<DirectDebitTransactionInformation23>,
}
#[derive(Debug, Default, Clone, PartialEq, ::serde::Serialize, ::serde::Deserialize, ::derive_builder::Builder, ::validator::Validate)]
